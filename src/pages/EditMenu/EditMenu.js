...
export default function EditMenu() {
  ...
  useEffect(() => {
    if (productId) {
      axios
        .get(
          `${process.env.REACT_APP_API_SERVER_URL}/api/v1/recipes/${productId}`
        )
        .then((response) => {
        ...
        const updatedIngredients = recipe.ingredient
          ? [
              ...
              ...selectedData.map((data, index) => ({
                ...data,
                seq: index + recipe.ingredient.length,
              })),
            ]
          : [...selectedData];
        return {
  ...
  return (
    <div>
      ...
      {isButton1Clicked ? (
        <ContainerI>
          <label style={{ margin: "0px 0px 0 25px", fontSize: "20px" }}>
            {" "}
            추가 항목
          </label>
          <label
            style={{
              margin: "0px 8px 0px 461px",
              fontSize: "20px",
              fontWeight: "bold",
            }}
          >
          ...
          <label style={{ margin: "5px 110px 0px 0px", fontSize: "14px" }}>
            {" "}
            233ml
          </label>
          <label
          ...
          <label style={{ margin: "5px 0px 0px 0px", fontSize: "14px" }}>
            {" "}
            600ml
          </label>
        </ContainerI>
      ...
      <div style={{ display: "flex", alignItems: "center" }}>
        ...
        {ModalCancelRegisterMenuOpen && (
          <ModalCancelRegisterMenu_edit
